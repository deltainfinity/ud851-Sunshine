...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar mWeatherDataProgressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWeatherDataProgressBar = (ProgressBar)findViewById(R.id.pb_weather_data_loading);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute(){
            ...
            mWeatherDataProgressBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            mWeatherDataProgressBar.setVisibility(View.INVISIBLE);

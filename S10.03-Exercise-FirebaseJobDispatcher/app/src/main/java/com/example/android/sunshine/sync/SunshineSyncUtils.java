...
//  DONE (10) Add constant values to sync Sunshine every 3 - 4 hours
    private static final int SYNC_SUNSHINE_HOURS  = 3;
    private static final int SYNC_SUNSHINE_SECONDS = (int)TimeUnit.HOURS.toSeconds(SYNC_SUNSHINE_HOURS);
    private static final int SYNC_FLEX_TIME = 3600;
...
//  DONE (12) Create a method to schedule our periodic weather sync
    public static void scheduleWeatherSync(Context context){
        ...
        FirebaseJobDispatcher weatherSyncJobDispatcher = new FirebaseJobDispatcher(driver);
        Job weatherSyncJob = weatherSyncJobDispatcher.newJobBuilder()
                .setTrigger(Trigger.executionWindow(SYNC_SUNSHINE_SECONDS,
                        SYNC_SUNSHINE_SECONDS+SYNC_FLEX_TIME))
                .setLifetime(Lifetime.UNTIL_NEXT_BOOT)
                .setRecurring(true)
                .setService(SunshineFirebaseJobService.class)
                .setTag(SUNSHINE_SYNC_TAG)
                .build();
        weatherSyncJobDispatcher.schedule(weatherSyncJob);
    }
